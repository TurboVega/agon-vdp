...
void otf(void * pvParameters) {
	...
	di_manager->create_solid_rectangle(43, ROOT_PRIMITIVE_ID, 1, 120, 120, 100, 100, PIXEL_COLOR_ABGR(PIXEL_ALPHA_50, 0, 0, 2));
...
#define DO_ELLIPSES 0
	...
	//di_manager->move_primitive_relative(100, 100, 100);
	//di_manager->move_primitive_relative(101, 200, 200);
	//di_manager->move_primitive_relative(102, 300, 100);
	//di_manager->move_primitive_relative(103, 400, 200);
