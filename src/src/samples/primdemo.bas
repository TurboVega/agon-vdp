...
20030 FOR I%=0 TO 4
20040 ID%=FN_GetID
20050 X1%=RND(60)+10:Y1%=RND(60)+5
20060 X2%=RND(60)+10:Y2%=RND(60)+5
20070 X3%=RND(60)+10:Y3%=RND(60)+5
20080 X4%=RND(60)+10:Y4%=RND(60)+5
20090 VDU OTF%;60,ID%;GRP%;FDFLT%;FN_Color,X1%;Y1%;X2%;Y2%;X3%;Y3%;X4%;Y4%;
20100 VDU OTF%;4,ID%;
20110 NEXT I%
20998 =GRP%
20999 REM -----------
...
21030 FOR I%=0 TO 4
21040 ID%=FN_GetID
21050 X1%=RND(60)+10:Y1%=RND(60)+5
21060 X2%=RND(60)+10:Y2%=RND(60)+5
21070 X3%=RND(60)+10:Y3%=RND(60)+5
21080 X4%=RND(60)+10:Y4%=RND(60)+5
21090 VDU OTF%;61,ID%;GRP%;FDFLT%;FN_Color,X1%;Y1%;X2%;Y2%;X3%;Y3%;X4%;Y4%;
21100 VDU OTF%;4,ID%;
21110 NEXT I%
21998 =GRP%
21999 REM -----------
