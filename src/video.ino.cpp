# 1 "C:\\Users\\restd\\AppData\\Local\\Temp\\tmpbtgb781y"
#include <Arduino.h>
...
# 678 "D:/AgonLight2/agon-vdp/src/video.ino"
int change_resolution(int colours, char * modeLine) {
...
# 719 "D:/AgonLight2/agon-vdp/src/video.ino"
int change_mode(int mode) {
 int errVal = -1;
...
# 1760 "D:/AgonLight2/agon-vdp/src/video.ino"
     case 4: {
   int b = readByte_t(); if(b == -1) return;
   current_sprite = b;
